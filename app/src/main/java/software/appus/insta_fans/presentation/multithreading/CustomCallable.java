...
public abstract class CustomCallable implements Callable {
    ...
    protected final WeakReference<CustomThreadPoolManager> mPoolManagerRef;


    public CustomCallable(CustomThreadPoolManager customThreadPoolManagerWeakReference) {
        mPoolManagerRef = new WeakReference<>(customThreadPoolManagerWeakReference);
    }
